...
export default function UISection() {
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-7xl px-6 py-36 lg:px-8">
          ...
          >
            ...
            <defs>
              <radialGradient id="759c1415-0410-454c-8f7c-9a820de03641">
                <stop offset="0%" stopColor="#333333" /> {/* gray-900 */}
                <stop offset="100%" stopColor="#EF4444" /> {/* red-500 */}
              </radialGradient>
            </defs>
          </svg>
          <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
            <h2 className="font-hanken text-3xl font-semibold tracking-tight text-white sm:text-4xl">
              Una experiencia
              <br />
              <span className="text-red-500">única.</span>
            </h2>
            <p className="mt-6 text-lg leading-8 text-gray-300">
              Plataforma de fácil usabilidad, disponible también para
